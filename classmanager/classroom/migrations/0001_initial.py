# Generated by Django 2.2.12 on 2021-01-09 20:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('submitted_file', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='submission_for_file', to='classroom.ClassAssignment')),
        ...
        migrations.AddField(
            ...
            name='student',
            field=models.ManyToManyField(related_name='student_file', to='classroom.Student'),
        ),
        migrations.AddField(
            model_name='classassignment',
            name='teacher',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='teacher_file', to='classroom.Teacher'),
        ),
